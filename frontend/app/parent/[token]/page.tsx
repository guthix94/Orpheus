...
export default function ParentPortalPage() {
  ...
  return (
    <div className="min-h-screen bg-cream">
      {/* Header — sticky */}
      <header className="sticky top-0 z-30 border-b border-sand bg-cream/90 backdrop-blur-sm pt-[var(--safe-area-top)]">
      ...
      {/* Tabs */}
      <div className="sticky z-20 border-b border-sand bg-cream/90 backdrop-blur-sm [top:calc(89px_+_var(--safe-area-top))]">
